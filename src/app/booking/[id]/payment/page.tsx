      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            <h2 className="font-semibold text-gray-900 mb-2">Booking Details</h2>
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div className="flex justify-between">
                <span>Date:</span>
                <span>{booking && format(new Date(booking.startTime), "MMM d, yyyy")}</span>
              </div>
              <div className="flex justify-between">
                <span>Time:</span>
                <span>
                  {booking && format(new Date(booking.startTime), "h:mm a")} - {booking && format(new Date(booking.endTime), "h:mm a")}
                </span>
              </div>
            </div>
          </div>
